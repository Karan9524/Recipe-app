    ...
    return (
        <>
            ...
            <div className='hotel-full-container'>
               <img src='images/hotel4.avif' />
            </div>
            <div className='total-meals'>
                <div className='up-total-meals1'>
                    <img src='images/total-meal.png' /><p>Total Meals: <span>8</span></p>
                </div>
                <div className='up-total-meals2'>
                    <img src='images/total-ing.png' /><p>Total Ingredients: <span>8</span></p>
                </div>
                <div className='up-total-meals3'>
                    <img src='images/total-image.png' /><p>Images: <span>8</span></p>
                </div>
            </div>
