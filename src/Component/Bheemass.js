        ...
        <>
            ...
            <div className='total-meals'>
                <div className='up-total-meals1'>
                    <img src='images/total-meal.png' /><p>Total Meals: <span>56</span></p>
                </div>
                <div className='up-total-meals2'>
                    <img src='images/total-ing.png' /><p>Total Ingredients: <span>40</span></p>
                </div>
                <div className='up-total-meals3'>
                    <img src='images/total-image.png' /><p>Images: <span>56</span></p>
                </div>
            </div>
